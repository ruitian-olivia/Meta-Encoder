...
class LinearProbeReg(torch.nn.Module):
    ...
    def __init__(self, embed_dim, num_heads, feature_num, latent_dim, gene_num):
        ...
        self.fc1 = torch.nn.Linear(embed_dim, latent_dim)
...
def main():
    ...
    for version_index in range(10):
        ...
        for fold_name in fold_list:
            ...
            model = LinearProbeReg(args.embed_dim, args.num_heads, args.feature_num, args.latent_dim, len(target_genes))
