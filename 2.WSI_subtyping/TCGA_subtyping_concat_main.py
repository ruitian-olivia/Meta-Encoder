...
def main():
    ...
    for version_index in range(10):
        ...
        for fold_name in fold_list:
            ...
            for slide_name in subtyping_train['slide_name']:
                ...
                print("pt_data_concat.shape:", pt_data_concat.shape)
            ...
            model = LinearProbeReg(args.feature_num, 1)
            output_dir = os.path.join(args.output_root, args.cancer_type, f'Concat_{args.version}', f'{version_index}_{fold_name}')
    ...
    test_mean_df.to_csv(os.path.join(args.output_root, args.cancer_type, f'Concat_{args.version}', 'test_results_mean.csv'), float_format='%.4f')
    ...
    test_std_df.to_csv(os.path.join(args.output_root, args.cancer_type, f'Concat_{args.version}', 'test_results_std.csv'), float_format='%.4f')
