...
def main():
    ...
    if args.cancer_type == 'BRCA':
        ...
        mutation_df = pd.read_csv(os.path.join(mutation_root, 'tcga_CRC_mutation_info.csv'))
    ...
    for version_index in range(10):
        ...
        for fold_name in fold_list:
            ...
            model = LinearProbeReg(args.embed_dim, args.num_heads, args.feature_num, len(args.predict_genes))
...
argparser.add_argument('--cancer_type',         type=str, default='BRCA', choices=['BRCA', 'CRC'], help='Cancer type')
