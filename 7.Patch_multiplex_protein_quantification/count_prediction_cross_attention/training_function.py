...
def train(model,train_loader,optimizer,poisson_loss,device,args):
    model.train()
    ...
    for _, batch in enumerate(train_loader):
        ...
        optimizer.zero_grad()
        output = model(ordered_features[0], ordered_features[1], ordered_features[2])
...
def valid(model,loader,poisson_loss,args,use_sampling=False):
    model.eval()
