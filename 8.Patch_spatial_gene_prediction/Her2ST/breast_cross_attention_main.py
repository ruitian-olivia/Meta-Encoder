...
class LinearProbeReg(torch.nn.Module):
    ...
    def __init__(self, embed_dim, num_heads, gene_num, feature_size_list):
        ...
        self.fc = torch.nn.Linear(embed_dim*2, gene_num)
...
def main():
    ...
    for test_patient_id in filtered_patient_list:
        ...
        model = LinearProbeReg(args.embed_dim, args.num_heads, gene_num, feature_size_list)
