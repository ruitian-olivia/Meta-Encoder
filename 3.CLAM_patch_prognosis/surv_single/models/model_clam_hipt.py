...
class CLAM_SB(nn.Module):
    def __init__(self, path_input_dim=1024, gate = True, size_arg = "small", dropout = False, k_sample=8, n_classes=2,
        ...
        self.size_dict = {"small": [384, 384, 256], "big": [path_input_dim, 512, 384]}
        ...
        self.classifiers = nn.Linear(384, n_classes)
        instance_classifiers = [nn.Linear(384, 2) for i in range(n_classes)]
